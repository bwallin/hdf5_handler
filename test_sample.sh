...
#besstandalone -d"cerr,all" -c bes-testsuite/bes.conf -i bes-testsuite/h5.local/omi_l2.h5.dds.bescmd
besstandalone -c bes-testsuite/bes.conf -i bes-testsuite/h5.local/omi_l2.h5.dds.bescmd
